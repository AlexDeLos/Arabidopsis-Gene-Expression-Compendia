...
def search_geo_accessions(query, max_results=20, filter_organism="Arabidopsis thaliana"):
    ...
    try:
        ...
        id_list = record["IdList"]  # type: ignore  # noqa: PGH003
        ...
        for i in range(0, len(id_list), batch_size):
            ...
            for summary in summaries:  # pyright: ignore[reportOptionalIterable, reportGeneralTypeIssues]
...
def check_metadata_for_cel(gse):
    ...
    """
    for _gsm_name, gsm in gse.gsms.items():
