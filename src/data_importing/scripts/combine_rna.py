...
# Import the function from your utilities file
...
from src.data_importing.RNA_seq_processing_batch import combine_files_rnaseq
...
def main():
    ...
    output_filename = "Salmon_RNAseq_Combined.csv"
    ...
    combined_matrix, sample_map = combine_files_rnaseq(
        ...
        combine_genes=True,         # Matches your microarray logic
