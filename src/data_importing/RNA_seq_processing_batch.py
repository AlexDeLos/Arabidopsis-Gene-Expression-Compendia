...
class RNASeq_processor:
    ...
    def run_pipeline_batch(self, samplesheet_path, batch_out_dir):
        ...
        cmd = [
            ...
            "--skip_alignment",            # Skips STAR entirely
            ...
            "--gff", "/tudelft.net/staff-umbrella/GeneExpressionStorage/rnaseq_data/genome_indices/Araport11_patched_for_Nextflow.gff",
            
            # --- PRE-BUILT INDICES ---
            # Point these to the 'reference' folder generated by your indexing job
            "--salmon_index", "/tudelft.net/staff-umbrella/GeneExpressionStorage/rnaseq_data/genome_indices/reference/salmon",
            "--transcript_fasta", "/tudelft.net/staff-umbrella/GeneExpressionStorage/rnaseq_data/genome_indices/reference/genome.transcripts.fa",
